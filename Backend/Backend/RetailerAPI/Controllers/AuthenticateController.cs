...
namespace RetailerAPI.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] ClientUser model)
        {
            ...
            ed.EmailToId = user.Email;
            ed.EmailToName = user.FirstName;
            ed.EmailSubject = "New Registration";
            ed.EmailBody = "Welcome to Gijima's Assessment tooling application "+"\n"+"Thank you for choosing us";
            _emailService.SendEmail(ed);
